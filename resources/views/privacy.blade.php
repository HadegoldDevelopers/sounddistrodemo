...
<div class="bg-gray-50 min-h-screen">
  ...
  <section class="bg-black text-center py-20 px-6">
    <h1 class="text-5xl md:text-6xl font-extrabold text-pink-500 mb-4">Privacy Policy</h1>
  ...
  <div class="max-w-4xl mx-auto px-6 py-16">
    <div class="prose prose-gray max-w-none bg-white rounded-xl border border-gray-200 shadow-lg p-10">
      {!! $privacyPolicy ?: '<p class="text-gray-500">Privacy policy not yet published.</p>' !!}
    </div>
  </div>

  <!-- CTA Footer -->
  <section class="bg-pink-500 text-center py-16">
    <h2 class="text-3xl md:text-4xl font-extrabold text-white mb-4">Questions About Privacy?</h2>
    <p class="text-white mb-6">Our support team is here to help you understand how we protect your data.</p>
